...
var JobList = function (_a) {
    ...
    // variables
    var snapPoints = react_1.useMemo(function () { return ['100%', '100%']; }, []);
    ...
    var _g = react_1.useState({}), allJob = _g[0], setAllJob = _g[1];
    var _h = react_1.useState({}), selfTakenJob = _h[0], setSelfTakenJob = _h[1];
    var _j = react_1.useState({}), finishedJob = _j[0], setFinishedJob = _j[1];
    var _k = react_1.useState(selfTakenJob), jobList = _k[0], setJobList = _k[1];
    var _l = react_1.useState(null), jobModal = _l[0], setJobModal = _l[1];
    var _m = react_1["default"].useState([]), reqDocument = _m[0], setReqDocument = _m[1];
    var _o = react_1["default"].useState(), updateState = _o[1];
    // callbacks
            ...
            fetch(apiUrl, {
                ...
                response
                    ...
                    if (dataRes.success == true) {
                        ...
                        react_native_1.Alert.alert('Submit Success', 'Request berhasil disimpan, menunggu konfirmasi', [{ text: 'OK', onPress: function () { return NavigationService_1["default"].goBack(); } }]);
                    }
    ...
    return (react_1["default"].createElement(bottom_sheet_1.BottomSheetModalProvider, null,
        ...
        react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].background },
            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].headerContainer },
                ...
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].titleScreen },
                    react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].headerText }, "Daftar Job"))),
        ...
        react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].bottomSheetContainer },
                ...
                react_1["default"].createElement(react_native_1.View, { style: { flex: 1, width: '100%' } },
                    react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].categoryListContainer }, categoryList.map(function (category, index) {
                        if (category.is_active) {
                            return (react_1["default"].createElement(react_native_1.View, { key: category.id, style: [
                            ...
                            return (react_1["default"].createElement(react_native_1.TouchableOpacity, { style: styles_1["default"].categoryPill, key: category.id, onPress: function () {
                                    isActiveOrNot(index);
                    ...
                    react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].listContainer },
                        ...
                        jobList.length > 0 ? (react_1["default"].createElement(react_native_1.FlatList, { fadingEdgeLength: 30, data: jobList, keyExtractor: function (item) { return item.task_id.toString(); }, refreshControl: react_1["default"].createElement(react_native_1.RefreshControl, { refreshing: refreshing, onRefresh: onRefresh }), renderItem: function (_a) {
                                    ...
                                    item.jobs.map(function (item) { return (react_1["default"].createElement(react_native_paper_1.List.Item, { title: item.task_name, description: react_1["default"].createElement(react_1["default"].Fragment, null,
                                            react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].descriptionListText },
                                                ...
                                                react_1["default"].createElement(react_native_1.Text, { style: { fontWeight: 'bold' } }, 'Diposting : ' +
                                                    moment_1["default"](item.created_at).format('DD-MM-YYYY kk:mm:ss')))), descriptionNumberOfLines: 4, titleStyle: styles_1["default"].titleListText, key: 'item' + item.id.toString(), left: function (props) { return (react_1["default"].createElement(react_1["default"].Fragment, null,
                                            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].topListContainer },
                                                ...
                                                react_1["default"].createElement(react_native_paper_1.IconButton, __assign({}, props, { style: styles_1["default"].iconStatus, icon: item.is_done === '0'
                                                        ? 'clipboard-text-outline'
                                                        : 'clipboard-check', color: item.is_done === '0'
                                                        ? theme_1.theme.colors.secondary
                                                        : theme_1.theme.colors.primary, size: 28 }))))); }, right: function (props) { return (react_1["default"].createElement(react_native_paper_1.List.Icon, __assign({}, props, { icon: "chevron-right", color: "#D3DCE6" }))); }, onPress: function () { return handlePresentModalPress(item); } })); })));
            ...
            jobModal ? (react_1["default"].createElement(bottom_sheet_1.BottomSheetModal, { ref: bottomSheetModalRef, index: 1, snapPoints: modalSnapPoints, backdropComponent: bottom_sheet_1.BottomSheetBackdrop, onChange: handleModalSheetChanges },
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].modalContentContainer },
                    react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].textContainerHeader },
                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].headerModalText }, jobModal.task_name),
                        ...
                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].muteHeaderModalText }, 'Diposting pada ' + jobModal.created_at)),
                    react_1["default"].createElement(react_native_1.View, { style: [styles_1["default"].textContainerHeader, { marginTop: 20 }] },
                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].sheetTitle }, "Permintaan Dokumen")),
                    react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].scrollListContainer },
                        react_1["default"].createElement(react_native_inset_shadow_1["default"], { left: false, right: false, top: false, shadowRadius: 20, shadowOpacity: 0.6, elevation: 20 },
                            react_1["default"].createElement(react_native_gesture_handler_1.ScrollView, { fadingEdgeLength: 30, style: styles_1["default"].documentScrollView, contentContainerStyle: { flexGrow: 1 }, refreshControl: react_1["default"].createElement(react_native_1.RefreshControl, { refreshing: refreshing, onRefresh: onRefresh }) }, jobModal.dataKelengkapan
