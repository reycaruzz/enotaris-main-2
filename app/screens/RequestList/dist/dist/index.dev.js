...
var RequestList = function RequestList(_a) {
  var route = _a.route; //param data

  var project_id = route !== undefined ? route.params.project_id : null;
  var project_name = route !== undefined ? route.params.project_name : null; // const project_desc = route !== undefined ? route.params.project_desc : null;

  var item_capture = route !== undefined ? route.params.item : null;
  var subservice_data = route !== undefined ? route.params.subservice_data : null; //user data

  var userData = react_redux_1.useSelector(function (state) {
    return state.loginReducer.userData;
  }); //isfocused hook

  var isFocused = native_1.useIsFocused(); //navigation service
  ...
  var onUploadPhoto = function onUploadPhoto(item, id, nama, uri, isButton) {
  ...
  var _o = react_1["default"].useState({}),
      rejectedList = _o[0],
      setRejectedList = _o[1];

  var _p = react_1.useState(requestedList),
      requestList = _p[0],
      setRequestList = _p[1];

  var _q = react_1.useState(null),
      detailModal = _q[0],
      setDetailModal = _q[1];
  ...
  var onChangeSearch = function onChangeSearch(query) {
    ...
    var filteredArrays = allRequestList.filter(function (_a) {
      var request_client = _a.request_client,
          subservices = _a.subservices,
          nama_bank = _a.nama_bank;

      if (nama_bank) {
        return request_client.toLowerCase().includes(query.toLowerCase()) || nama_bank.toLowerCase().includes(query.toLowerCase()) || subservices.some(function (item) {
          return item.sub_service_name.toLowerCase().includes(query.toLowerCase());
        });
      } else {
        return request_client.toLowerCase().includes(query.toLowerCase()) || subservices.some(function (item) {
          return item.sub_service_name.toLowerCase().includes(query.toLowerCase());
        });
      }
    });
  ...
  var populateData = function populateData(state, activeTab) {
    ...
    fetch(apiUrl.api + 'listrequest', {
      ...
      var confirmed = _.filter(json.data, function (item) {
        if (item.project_done === '1' && item.project_status === '2' && item.subservices.length > 0 && item.subservices[0].image_url === null) {
          return item;
        }
      });
      ...
      var done = _.filter(json.data, function (item) {
        if (item.is_approved === '1' && item.project_status === '2' && item.subservices.length > 0 && item.subservices[0].image_url) {
          return item;
        }
      });
  ...
  var _onRefresh = react_1["default"].useCallback(function () {
    setVisible(false);
    populateData(null, activeTab); // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [activeTab]);
  ...
  react_1["default"].useEffect(function () {
    if (item_capture && subservice_data) {
      ...
      setDetailModal(item_capture); // forceUpdate();
      // handlePresentModalPress(item_capture);
    } // eslint-disable-next-line react-hooks/exhaustive-deps

  }, [item_capture, subservice_data]); //jsx logic

  var getCashIcon = function getCashIcon(payment) {
    if (payment === '0') {
  ...
  var getStatusIcon = function getStatusIcon(item) {
  ...
  return react_1["default"].createElement(bottom_sheet_1.BottomSheetModalProvider, null, react_1["default"].createElement(react_native_1.View, {
  ...
  }, "Daftar Request"))), react_1["default"].createElement(react_native_1.View, {
  ...
  }), requestList.length > 0 ? react_1["default"].createElement(react_native_1.FlatList, {
    fadingEdgeLength: 30,
    data: requestList,
    ...
    renderItem: function renderItem(_a) {
      ...
      return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(react_native_1.View, {
        key: 'status' + item.id.toString() + index,
        style: styles_1["default"].topListContainer
      }, react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].headerListContainer,
        key: 'headerlist' + item.id.toString() + index
      }, item.is_approved === '0' ? react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].statusListTextWarning
      }, "Diajukan") : null, item.is_approved === '2' ? react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].statusListTextDanger
      }, "Ditolak") : null, item.is_approved === '1' && item.project_status === '1' ? react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].statusListTextInfo
      }, "Diproses") : null, item.is_approved === '1' && item.project_status === '2' && item.subservices.length > 0 && !item.subservices[0].image_url || item.is_approved === '1' && item.project_status === '2' && !item.subservices.length > 0 ? react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].statusListTextSuccess
      }, "Disetujui") : null, item.is_approved === '1' && item.project_status === '2' && item.subservices.length > 0 && item.subservices[0].image_url ? react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].statusListTextMute
      }, "Selesai") : null), project_id === '1' ? react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].topTextContainer,
        ...
        style: styles_1["default"].postDateText
      }, item.nama_bank || 'Bank tidak tersedia')) : [item.request_payment ? react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].topTextContainer,
        key: 'headertext' + item.id.toString() + index
      }, react_1["default"].createElement(react_native_paper_1.IconButton, {
        style: styles_1["default"].postDateIcon,
        ...
        style: styles_1["default"].postDateText
      }, item.request_payment === '0' ? 'DP/Uang Muka' : [item.request_payment === '1' ? 'Lunas' : 'Belum melakukan pembayaran'])) : null]), react_1["default"].createElement(react_native_paper_1.List.Item, {
        ...
        }, [item.subservices && item.subservices.length > 0 ? item.subservices.map(function (doc) {
          return doc.sub_service_name;
        ...
        left: function left(props) {
          return react_1["default"].createElement(react_native_paper_1.IconButton, __assign({}, props, {
            style: styles_1["default"].requestItem,
        ...
        onPress: function onPress() {
          if (item.project_status === '2' || item.is_approved === '2') {
  ...
  }, "Data pekerjaan belum tersedia untuk saat ini"))))), react_1["default"].createElement(bottom_sheet_1.BottomSheetModal, {
    ref: bottomSheetModalRef,
    index: 1,
    snapPoints: modalSnapPoints,
    backdropComponent: bottom_sheet_1.BottomSheetBackdrop,
    onChange: handleModalSheetChanges
  }, detailModal ? react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(react_native_1.View, {
    style: styles_1["default"].modalContentContainer
  }, react_1["default"].createElement(react_native_1.View, {
    style: styles_1["default"].scrollListContainer
  }, react_1["default"].createElement(react_native_gesture_handler_1.ScrollView, {
    fadingEdgeLength: 30,
    contentContainerstyle: styles_1["default"].documentScrollView
  }, react_1["default"].createElement(react_native_1.Text, {
  ...
  }, detailModal.request_client), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Kontak Klien"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText, {
      marginBottom: 10
    }]
  }, detailModal.request_contact || 'Tidak ada kontak'), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Nama Bank"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText, {
      marginBottom: 10
    }]
  }, detailModal.nama_bank || 'Tidak ada bank'), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Nama Order"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText, {
      marginBottom: 10
    }]
  }, detailModal.request_name), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Catatan Order"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText, {
      marginBottom: 10
    }]
  }, detailModal.keterangan || 'Tidak ada catatan'), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Detail Biaya"), react_1["default"].createElement(react_native_1.View, {
    style: {
      flexDirection: 'row'
    }
  }, react_1["default"].createElement(react_native_1.Text, {
  ...
  }, "Biaya Order :"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText]
  }, detailModal.request_payment_amount ? 'Rp ' + detailModal.request_payment_amount : 'Tidak ada biaya')), react_1["default"].createElement(react_native_1.View, {
    style: {
      flexDirection: 'row'
    }
  }, react_1["default"].createElement(react_native_1.Text, {
  ...
  }, "Biaya BPN :"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText]
  }, detailModal.request_payment_amount ? 'Rp ' + detailModal.request_payment_amount : 'Tidak ada biaya')), react_1["default"].createElement(react_native_1.View, {
    style: {
      flexDirection: 'row'
  ...
  }, "Biaya Notaris :"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText]
  }, detailModal.request_payment_amount ? 'Rp ' + detailModal.request_payment_amount : 'Tidak ada biaya')), react_1["default"].createElement(react_native_1.View, {
    style: {
      flexDirection: 'row'
  ...
  }, "Biaya Plafond Awal :"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText]
  }, detailModal.request_payment_amount ? 'Rp ' + detailModal.request_payment_amount : 'Tidak ada biaya')), react_1["default"].createElement(react_native_1.View, {
    style: {
      flexDirection: 'row'
  ...
  }, "Biaya Plafond Akhir :"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].subHeaderModalText, {
      marginBottom: 10
    }]
  }, detailModal.request_payment_amount ? 'Rp ' + detailModal.request_payment_amount : 'Tidak ada biaya')), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].headerModalText
  }, "Histori"), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].muteHeaderModalText
  }, '• Diposting pada ' + detailModal.created_at), react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].muteHeaderModalText
  }, detailModal.is_approved === '2' ? '• Ditolak pada ' + detailModal.approved_at : '• Disetujui pada ' + detailModal.approved_at), react_1["default"].createElement(react_native_1.View, {
    style: {
      height: 20
    }
  })))), react_1["default"].createElement(react_native_1.View, {
    ...
    style: styles_1["default"].innerSheetContainer
  }, react_1["default"].createElement(react_native_1.View, {
    style: [styles_1["default"].textContainerHeader]
  }, react_1["default"].createElement(react_native_1.Text, {
  ...
  }, "Jenis Layanan")), react_1["default"].createElement(react_native_1.View, {
    style: styles_1["default"].scrollListContainer
  ...
  }, subService.length > 0 && subService[0].image_url ? react_1["default"].createElement(react_native_1.View, {
    key: "scrolltextcontainer",
    style: styles_1["default"].scrollTextContainerHeader
  }, react_1["default"].createElement(react_native_1.Text, {
    style: styles_1["default"].muteHeaderModalText
  }, "Sudah melakukan serah terima")) : [detailModal.project_done === '1' ? react_1["default"].createElement(react_native_1.View, {
  ...
  }, "Ketuk nama layanan untuk menambah bukti serah terima"), react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].muteHeaderModalText, {
      color: 'white'
    }]
  }, "* Semua layanan harus memiliki bukti serah terima untuk dapat dikirim")) : react_1["default"].createElement(react_native_1.View, {
    key: "scrolltextcontainerheader",
    style: styles_1["default"].scrollTextContainerHeader
  }, react_1["default"].createElement(react_native_1.Text, {
    style: [styles_1["default"].muteHeaderModalText, {
  ...
  }, "Order ini belum bisa menerima upload bukti serah terima"))], subService ? subService.map(function (item, index) {
    ...
    }, item.sub_service_name)), react_1["default"].createElement(react_native_paper_1.Divider, {
      styles: {
        width: '80%'
      }
    }), react_1["default"].createElement(react_native_1.Text, {
      style: styles_1["default"].checkboxFileLabel
    }, item.fileName || item.image_url ? item.fileName || item.image_url : '* Bukti serah terima belum tersedia'));
  }) : null))), _.filter(subService, function (o) {
    return o.img64 !== undefined;
  }).length === subService.length ? react_1["default"].createElement(react_native_1.View, {
  ...
  }, loader ? 'Mengirimkan..' : 'Kirim Bukti Serah Terima')) : null))) : null)), react_1["default"].createElement(react_native_paper_1.Snackbar, {
    visible: visible,
    style: {
