...
var ProjectList = function (_a) {
    var route = _a.route;
    //param data
    var job_data = route !== undefined ? route.params.job_data : null;
    //fetch user data
    var userData = react_redux_1.useSelector(function (state) { return state.loginReducer.userData; });
    //navigation service
    var onUploadPhoto = function (item, id_kelengkapan, id_document, uri, isButton) {
    ...
    var _d = react_1.useState(false), loader = _d[0], setLoader = _d[1];
    var _e = react_1.useState(categoryService), serviceTypeList = _e[0], setServiceTypeList = _e[1];
    var _f = react_1.useState(categoryDefault), categoryList = _f[0], setCategoryList = _f[1];
    var _g = react_1.useState(0), categoryId = _g[0], setCategoryId = _g[1];
    var _h = react_1.useState([]), allJob = _h[0], setAllJob = _h[1];
    var _j = react_1.useState([]), selfTakenJob = _j[0], setSelfTakenJob = _j[1];
    var _k = react_1.useState([]), finishedJob = _k[0], setFinishedJob = _k[1];
    var _l = react_1.useState(selfTakenJob), jobList = _l[0], setJobList = _l[1];
    var _m = react_1.useState(null), jobModal = _m[0], setJobModal = _m[1];
    var _o = react_1["default"].useState([]), reqDocument = _o[0], setReqDocument = _o[1];
    //callbacks
    //use to force re render
    var _p = react_1["default"].useState(), updateState = _p[1];
    var forceUpdate = react_1["default"].useCallback(function () { return updateState({}); }, []);
    var populateData = function (state, category_id) {
        ...
        fetch(apiUrl_1.apiUrl.api + 'joblistproject', {
            ...
            response
                .json()
                .then(function (data) {
                var alljobdata = _(data.data)
                    .groupBy(function (x) { return x.task_name; })
                    ...
                    .value();
                var todojobdata = _(_.filter(data.data, ['is_done', '0']))
                    .groupBy(function (x) { return x.task_name; })
                    .map(function (value, key) { return ({
                    task_name: key,
                    task_id: value[0].task_id,
                    ...
                    .value();
                var donejobdata = _(_.filter(data.data, ['is_done', '1']))
                    .groupBy(function (x) { return x.task_name; })
                    .map(function (value, key) { return ({
                    task_name: key,
                    task_id: value[0].task_id,
    ...
    var onSubmit = function () {
        if (_.uniqBy(reqDocument, 'id_document').length === 0 &&
            ...
            fetch(apiUrl, {
                ...
                response
                    ...
                    if (dataRes.success == true) {
                        ...
                        react_native_1.Alert.alert('Submit Success', 'Request berhasil disimpan, menunggu konfirmasi', [{ text: 'OK', onPress: function () { return onRefresh(); } }]);
                    }
    ...
    var onChangeSearch = function (query) {
        var filteredArrays = allJob.filter(function (_a) {
            var task_name = _a.task_name, jobs = _a.jobs;
            return (task_name.toLowerCase().includes(query.toLowerCase()) ||
                jobs.some(function (item) {
        ...
        react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].background },
            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].headerContainer },
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].textContainerHeader },
                    react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].headerMenuText }, "MENU JOB"))),
            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].searchbarContainer },
                react_1["default"].createElement(react_native_paper_1.Searchbar, { placeholder: "Cari job", style: styles_1["default"].searchbar, inputStyle: styles_1["default"].searchbarInput, onChangeText: onChangeSearch, theme: {
                        colors: {
            ...
            react_1["default"].createElement(react_native_1.ScrollView, { fadingEdgeLength: 30, style: styles_1["default"].categoryListContainer, horizontal: true, ref: scrollCategoryRef, showsHorizontalScrollIndicator: false }, serviceTypeList.map(function (category, index) {
                return (react_1["default"].createElement(react_native_1.TouchableOpacity, { style: category.is_active
                        ? [
                            ...
                            { borderWidth: 3, borderColor: theme_1.theme.colors.secondary },
                        ]
        ...
        react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].bottomSheetContainer },
            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].sheetContainer },
                ...
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].jobListContainer },
                    react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].categoryListContainer }, categoryList.map(function (category, index) {
                        return (react_1["default"].createElement(react_native_1.TouchableOpacity, { style: category.is_active
                                ? [
                                ...
                                : [styles_1["default"].categoryPillBordered], key: category.id, onPress: function () {
                                isActiveOrNot(index);
                            }, underlayColor: theme_1.theme.colors.secondary },
                            react_1["default"].createElement(react_native_1.View, { key: category.id },
                                react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].categoryText }, category.name))));
                    })),
                    react_1["default"].createElement(react_native_1.FlatList, { fadingEdgeLength: 30, data: jobList || [], keyExtractor: function (item, index) { return index.toString(); }, style: { width: '100%', paddingHorizontal: 10 }, refreshControl: react_1["default"].createElement(react_native_1.RefreshControl, { refreshing: refreshing, onRefresh: onRefresh }), contentContainerStyle: { paddingBottom: 100 }, ListEmptyComponent: react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].emptyStateContainer },
                            react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].emptyStateTitle }, "Data tidak ditemukan"),
                            react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].emptyStateText }, "Anda tidak memiliki job atau tugas")), renderItem: function (_a) {
                            var item = _a.item, index = _a.index;
                            return (react_1["default"].createElement(react_native_paper_1.List.Section, { key: 'section' + index.toString() },
                                react_1["default"].createElement(react_native_paper_1.List.Subheader, { key: 'subheader' + index.toString() }, item.task_name),
                                item.jobs.map(function (item) { return (react_1["default"].createElement(react_native_paper_1.List.Item, { title: item.task_name, description: react_1["default"].createElement(react_1["default"].Fragment, null,
                                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].descriptionListText },
                                            item.job_document
                                                .map(function (doc) { return doc.nama_dokumen; })
                                                .join('  •  ') +
                                                '\nProject : ' +
                                                item.project_name +
                                                '\n',
                                            item.due_date && (react_1["default"].createElement(react_native_1.Text, { style: { fontWeight: 'bold' } }, 'Deadline : ' +
                                                moment_1["default"](item.due_date).format('DD-MM-YYYY') +
                                                '\n')),
                                            react_1["default"].createElement(react_native_1.Text, null, 'Diposting : ' +
                                                moment_1["default"](item.created_at).format('DD-MM-YYYY ')))), descriptionNumberOfLines: 4, titleStyle: react_native_1.Platform.OS === 'ios'
                                        ? [styles_1["default"].titleListText, { fontWeight: 'bold' }]
                                        : styles_1["default"].titleListText, key: 'item' + item.id.toString(), left: function () {
                                        ...
                                        return (react_1["default"].createElement(react_1["default"].Fragment, null,
                                            react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].topListContainer },
                                                [
                                                    item.is_done === '0' ? (react_1["default"].createElement(react_native_1.View, { key: "headerlistcontainer", style: styles_1["default"].headerListContainer },
                                                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].statusListTextWarning }, "Tugas"))) : (react_1["default"].createElement(react_native_1.View, { key: "headerlistcontainer", style: styles_1["default"].headerListContainer },
                                                        react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].statusListTextSuccess }, "Selesai"))),
                                                ],
                                                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].serviceImageIconList },
            ...
            react_1["default"].createElement(bottom_sheet_1.BottomSheetModal, { ref: bottomSheetModalRef, index: 1, snapPoints: modalSnapPoints, backdropComponent: bottom_sheet_1.BottomSheetBackdrop, onChange: handleModalSheetChanges }, jobModal ? (react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].modalContentContainer },
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].textContainerHeader },
                    react_1["default"].createElement(react_native_1.Text, { style: [styles_1["default"].sheetTitle, { fontSize: 18 }] }, jobModal.task_name),
                    react_1["default"].createElement(react_native_paper_1.Divider, { styles: { width: '80%' } }),
                    jobModal.due_date && (react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].deadlineContainer },
                        ...
                        react_1["default"].createElement(react_native_1.Text, { style: [
                                styles_1["default"].subHeaderModalText,
                                { fontFamily: 'Inter-Bold' },
                            ] }, moment_1["default"](jobModal.due_date).format('DD-MM-YYYY')))),
                    react_1["default"].createElement(react_native_1.Text, { style: [styles_1["default"].subHeaderModalText, { marginTop: 10 }] }, jobModal.project_name),
                    react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].muteHeaderModalText }, 'Diposting pada ' +
                        moment_1["default"](jobModal.created_at).format('DD-MM-YYYY HH:mm:ss'))),
                react_1["default"].createElement(react_native_paper_1.Divider, { styles: { width: '80%' } }),
                react_1["default"].createElement(react_native_1.View, { style: [styles_1["default"].textContainerHeader, { marginTop: 20 }] },
                    react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].headerModalText }, "Permintaan Dokumen")),
                react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].scrollListContainer },
                    react_1["default"].createElement(react_native_inset_shadow_1["default"], { left: false, right: false, top: false, shadowRadius: 20, shadowOpacity: 0.6, elevation: 20 },
                        react_1["default"].createElement(react_native_gesture_handler_1.ScrollView, { style: styles_1["default"].documentScrollView, contentContainerStyle: { flexGrow: 1 }, refreshControl: react_1["default"].createElement(react_native_1.RefreshControl, { refreshing: refreshing, onRefresh: onRefresh }) }, jobModal.dataKelengkapan
                            ? jobModal.dataKelengkapan.map(function (item, index) { return (react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].documentListContainer, key: index },
                                ...
                                react_1["default"].createElement(react_native_paper_1.Divider, { styles: { width: '80%' } }),
                                react_1["default"].createElement(react_native_1.Text, { style: styles_1["default"].checkboxFileLabel }, item.fileName
                                    ? item.fileName
                                    : '* Bukti foto belum tersedia'))); })
                            : null))),
                jobModal.is_done === '0' ? (react_1["default"].createElement(react_native_1.View, { style: styles_1["default"].submitButtonContainer },
                    react_1["default"].createElement(react_native_paper_1.Button, { mode: "contained", onPress: onSubmit, labelStyle: [styles_1["default"].buttonSubmitLabel], style: styles_1["default"].buttonSubmit }, loader ? 'Mengirimkan..' : 'Kirim Dokumen'))) : null)) : null))));
};
