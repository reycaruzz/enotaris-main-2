...
var Report = function Report(_a) {
  //navigation service
  var onBack = function onBack() {
    return NavigationService_1["default"].goBack();
  };

  var onDetail = function onDetail(item) {
    NavigationService_1["default"].navigate('DetailPegawai', {
      item: item
    });
  };
  ...
  var populateData = function populateData() {
    setLoader(true);
    fetch(apiUrl_1.apiUrl.api + 'listrequestresume').then(function (response) {
  ...
  var scrollCategoryRef = react_1.useRef(); //Hooks
  ...
  var _d = react_1.useState(categoryService),
      serviceTypeList = _d[0],
      setServiceTypeList = _d[1];
  ...
  var onChangeSearch = function onChangeSearch(query) {
    ...
    var filteredArrays = allUser.filter(function (_a) {
      var roleuser = _a.roleuser,
          nama = _a.nama;
      return nama.toLowerCase().includes(query.toLowerCase()) || roleuser.toLowerCase().includes(query.toLowerCase());
    });
  ...
  return react_1["default"].createElement(react_1["default"].Fragment, null, react_1["default"].createElement(react_native_1.View, {
    ...
    style: react_native_1.Platform.OS === 'ios' ? [styles_1["default"].headerMenuText, {
      fontWeight: 'bold'
    }] : styles_1["default"].headerMenuText
  }, "REPORT"))), react_1["default"].createElement(react_native_1.View, {
  ...
  }, "Pegawai")), userList.length > 0 ? react_1["default"].createElement(react_native_1.FlatList, {
    fadingEdgeLength: 30,
    data: userList,
    ...
    renderItem: function renderItem(_a) {
      ...
      return react_1["default"].createElement(react_native_1.TouchableOpacity, {
        ...
        style: styles_1["default"].imageRowContainer
      }, react_1["default"].createElement(react_native_1.View, {
        ...
        style: styles_1["default"].profileImageStatus
      }, react_1["default"].createElement(react_native_1.Image, {
        source: {
          uri: service.img_url
        },
      ...
      }, truncate(item.nama, 2)), react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].descriptionListText
      }, item.roleuser)), react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].requestCountContainer
      }, react_1["default"].createElement(react_native_1.Text, {
        style: [styles_1["default"].headerText, {
          color: theme_1.theme.colors.primary
        }]
      }, item.task_detail[0].task_done), react_1["default"].createElement(react_native_1.Text, {
        style: [styles_1["default"].headerText, {
          fontSize: 9
        }]
      }, "Task")), react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].requestCountContainer
      }, react_1["default"].createElement(react_native_1.Text, {
        style: [styles_1["default"].headerText, {
          color: theme_1.theme.colors.primary
        }]
      }, item.resume_detail[0].done), react_1["default"].createElement(react_native_1.Text, {
        style: [styles_1["default"].headerText, {
          fontSize: 9
        }]
      }, "Request")), item.task_detail[0].task_done_today && item.task_detail[0].task_done_today !== '0' && react_1["default"].createElement(react_native_1.View, {
        style: styles_1["default"].taskTodayStatusContainer
      }, react_1["default"].createElement(react_native_1.Text, {
        style: styles_1["default"].taskTodayStatus
