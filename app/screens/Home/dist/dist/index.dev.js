...
var Home = function Home() {
  ...
  var TabBarComponent = function TabBarComponent(props) {
    return react_1["default"].createElement(react_navigation_tabs_1.BottomTabBar, __assign({}, props));
  };
  ...
  var TabNavigator = react_navigation_tabs_1.createBottomTabNavigator({
    DASHBOARD: {
      ...
      navigationOptions: {
        tabBarIcon: function tabBarIcon(_a) {
    ...
    tabBarComponent: function tabBarComponent(props) {
      return react_1["default"].createElement(TabBarComponent, __assign({}, props, {
...
exports["default"] = Home; // import React, { useState, useRef } from 'react';
