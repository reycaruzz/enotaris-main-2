...
var PaperThemeDefault = __assign(__assign({}, react_native_paper_1.DefaultTheme), { colors: __assign(__assign({}, react_native_paper_1.DefaultTheme.colors), { primary: '#F9A826' }), fonts: react_native_paper_1.configureFonts(fontConfig) });
var PaperThemeDark = __assign(__assign({}, react_native_paper_1.DarkTheme), { colors: __assign(__assign({}, react_native_paper_1.DarkTheme.colors), { primary: '#F9A826' }), fonts: react_native_paper_1.configureFonts(fontConfig) });
var CombinedDefaultTheme = __assign(__assign(__assign({}, react_native_paper_1.DefaultTheme), native_1.DefaultTheme), { fonts: react_native_paper_1.configureFonts(fontConfig) });
var CombinedDarkTheme = __assign(__assign(__assign({}, react_native_paper_1.DarkTheme), native_1.DarkTheme), { colors: __assign(__assign({}, native_1.DarkTheme.colors), { background: '#303030', card: '#222222', text: '#ffffff', textInput: '#222222' }), fonts: react_native_paper_1.configureFonts(fontConfig) });
var _a = store_1["default"](), persistor = _a.persistor, store = _a.store;
var RootNavigation = function () {
    ...
    var combinedTheme = isDark ? CombinedDarkTheme : CombinedDefaultTheme;
    //fetch user data
    ...
    react_1["default"].useEffect(function () {
        var backAction = function () {
            react_native_1.Alert.alert('Keluar aplikasi', 'Apakah anda yakin untuk keluar dari aplikasi?', [
                ...
                { text: 'YA', onPress: function () { return react_native_1.BackHandler.exitApp(); } },
            ]);
            return true;
        };
    ...
    messaging_1["default"]().setBackgroundMessageHandler(function (remoteMessage) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
    ...
    var checkVersion = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, react_native_version_check_1["default"].needUpdate()];
                case 1:
    ...
    var saveTokenToDatabase = function (token) {
        var postData = new FormData();
        postData.append('user_id', userData.iduser);
        postData.append('fcm_token', token);
        fetch(apiUrl_1.apiUrl.api + 'setToken', {
            method: 'POST',
            body: postData
        })["catch"](function (error) { return console.error(error); });
    };
    return (react_1["default"].createElement(react_native_paper_1.Provider, { theme: paperTheme },
        react_1["default"].createElement(navigation_1["default"], { theme: combinedTheme })));
};
var Entrypoint = function () {
    return (react_1["default"].createElement(react_redux_1.Provider, { store: store },
        react_1["default"].createElement(react_2.PersistGate, { loading: react_1["default"].createElement(react_native_1.ActivityIndicator, null), persistor: persistor },
